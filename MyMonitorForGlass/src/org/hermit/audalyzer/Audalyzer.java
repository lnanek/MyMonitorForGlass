...
import com.neatocode.mymonitor.R;
import com.neatocode.mymonitor.AnalyzerDisplay;
import com.neatocode.mymonitor.BrightnessAnalyzer;
import com.neatocode.mymonitor.LookingAtPartnerAnalyzer;
import com.neatocode.mymonitor.NearCrowdedLocationAnalyzer;
import com.neatocode.mymonitor.ScoreAnalyzer;
...
public class Audalyzer extends MainActivity {
    ...
    public void onCreate(Bundle icicle) {
    	...
    	AnalyzerDisplay.getOrCreateInstance(this);
    	LookingAtPartnerAnalyzer.getOrCreateInstance(this);
    	NearCrowdedLocationAnalyzer.getOrCreateInstance(this);
    	BrightnessAnalyzer.getOrCreateInstance(this);
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
    	...
    	if ( ev.getAction() == MotionEvent.ACTION_UP ) {
    		AnalyzerDisplay.getInstance().onTouchUp();
    	} else if ( ev.getAction() == MotionEvent.ACTION_DOWN ) {
    		AnalyzerDisplay.getInstance().onTouchDown();

            //ScoreAnalyzer.reset();
    	}
    	
    	// We don't need to track the touch while it is down,
    	// so return not consumed to not get further touches.
    	return false;
	...
	public boolean dispatchKeyEvent(final KeyEvent event) {
		Log.i("VoiceAnalyzer", "dispatchKeyEvent, event = " + event);
    ...
    private void updatePreferences() {
        ...
        /*
        int orientMode = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE;
        try {
